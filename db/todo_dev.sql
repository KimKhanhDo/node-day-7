...
-- ----------------------------
BEGIN;
INSERT INTO `users` (`id`, `name`, `email`, `password`, `refresh_token`, `refresh_expires_at`, `created_at`, `updated_at`) VALUES (1, 'Kim Nguyen', 'kim@example.com', 'password123', NULL, NULL, '2026-01-25 20:36:06', '2026-01-25 20:36:06');
INSERT INTO `users` (`id`, `name`, `email`, `password`, `refresh_token`, `refresh_expires_at`, `created_at`, `updated_at`) VALUES (2, 'John Doe', 'john@example.com', 'password123', NULL, NULL, '2026-01-25 20:36:06', '2026-01-25 20:36:06');
INSERT INTO `users` (`id`, `name`, `email`, `password`, `refresh_token`, `refresh_expires_at`, `created_at`, `updated_at`) VALUES (3, 'Alice Smith', 'alice@example.com', 'password123', NULL, NULL, '2026-01-25 20:36:06', '2026-01-25 20:36:06');
INSERT INTO `users` (`id`, `name`, `email`, `password`, `refresh_token`, `refresh_expires_at`, `created_at`, `updated_at`) VALUES (5, 'abc', 'abc@gmail.com', '12345678', NULL, NULL, '2026-01-26 13:30:01', '2026-01-26 13:30:01');
INSERT INTO `users` (`id`, `name`, `email`, `password`, `refresh_token`, `refresh_expires_at`, `created_at`, `updated_at`) VALUES (6, 'SuDo', 'su@gmail.com', '12345678', NULL, NULL, '2026-01-26 13:50:58', '2026-01-26 13:50:58');
INSERT INTO `users` (`id`, `name`, `email`, `password`, `refresh_token`, `refresh_expires_at`, `created_at`, `updated_at`) VALUES (7, 'DogDo', 'dog@gmail.com', '12345678', NULL, NULL, '2026-01-26 13:52:51', '2026-01-26 13:52:51');
INSERT INTO `users` (`id`, `name`, `email`, `password`, `refresh_token`, `refresh_expires_at`, `created_at`, `updated_at`) VALUES (8, 'Thuy Le', 'thuy@gmail.com', '$2b$10$WjeZ1UQj/2oZVau45VN7Neg0kwG0p5KneuQzy7ksv99Kh3bh4N/oW', 'BctYqF0sjKNNdW05LaSyWJAZBFb79OWw', '2026-02-04 11:47:16', '2026-01-27 11:28:10', '2026-01-28 11:47:15');
COMMIT;
